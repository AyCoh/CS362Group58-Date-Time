...
def my_datetime(num_sec):
    """
    Takes a non-negative integer value that represents number of seconds since Jan 1, 1970 (epoch) and converts to a date
    to be returned as a string in 'MM-DD-YYYY' format.
    """
    pass
